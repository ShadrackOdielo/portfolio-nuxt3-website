...
<template>
  ...
  >
    ...
    <p class="mb-5 font-recoleta">
      Details about my code and stuff <br />useful tools and improving. I hope some of the
...
useHead({
  title: "Blog - Shadrack Odielo",
  meta: [
    {
      name: "description",
      content:
        "My thoughts and reflections on web development, new technologies, useful tools and improving.",
    },
    // {
    //   name: "og:image",
